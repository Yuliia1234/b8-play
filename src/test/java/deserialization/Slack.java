...
public class Slack {
    ...
    @Test
            public void massageToSlack() throws URISyntaxException, IOException {
        ...
        HttpEntity entity=new StringEntity(PayloadUtils.getSlackMassagePayload("C026Q9VVD42",
                "Turcan: hello from java code"));
